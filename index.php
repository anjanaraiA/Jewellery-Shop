...
<?php
    ...
    <section id="hero">
        <div class="leftHero">
            <h4>A timeless choice for best jewellery</h4>
            <h2>Platinum jewellery is eternal</h2>
         
            <!-- <h1>Save more with coupons</h1> -->
            <p> <center></center></p>
            <button><a href="product.php">Order Now</a></button>
            <img src="img/Img3.jpg" alt="" height="100px" width="185px">

        </div>
        <div class="rightHero">
            <img class="heroImg" src="img/imgs.webp" alt="">
        </div>
    </section>
    <section class="category-title">
        <h1>Find the best platinum</h1>
    ...
    <section class="hotselling-title">
      ...
      <?php
        ...
        ?>
          ...
          <h3><div class="price">Rs.<?php echo $fetch_products['price']; ?>/-</div></h3>
