...
<body>
   ...
   <section id="product-banner">
        <div class="product-banner-text" background="img/product-banner.jpg" >
            <h1>"Accessorize Your Life with Fierce Charisma."</h1>
            <h2>Sparkle Like <span id="red"></span> You Mean It.</h2>
   ...
   <section class="products">
      ...
      <div class="box-container" id="product-title">
         <?php
                     ...
                     if (mysqli_num_rows($select_plants) > 0) {
                        while ($fetch_plants = mysqli_fetch_assoc($select_plants)) {
                           ...
                           <form action="" method="POST" class="box" onclick="window.location.href='view.php?pid=<?php echo $fetch_plants['id']; ?>'">
                              ...
                              <div class="price">Rs-<?php echo $fetch_plants['price']; ?>/-</div>
