...
if(isset($_POST['add_product'])){
   ...
   if(mysqli_num_rows($select_product_name) > 0){
      ...
      $insert_product = mysqli_query($con, "INSERT INTO `products`(name, type, details, price, image,p_quantity) VALUES('$name', '$type', '$details', '$price', '$image','$quantity')") or die('query failed');
