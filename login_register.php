        ...
        if (empty($fname) || empty($uname) || empty($email) || empty($pass) || empty($cpass)) {
            ...
            if ($result) {
                if (mysqli_num_rows($result) > 0) {
                    ...
                    $query = "INSERT INTO `registered_user`(`Full_name`, `Username`, `Email`, `Password`, `UserType`) VALUES ('$fname','$uname','$email','$pass','$_POST[type]')";
